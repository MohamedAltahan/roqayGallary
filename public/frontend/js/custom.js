...
jQuery(document).ready(function ($) {
    ...
    $(document).on("click", "a", function () {
        if (
            $(this).parent(".client-item").length == 0 &&
            !$(this).hasClass("popup") &&
            !$(this).hasClass("dropdown-toggle") &&
            $(this).attr("href")[0] != "#" &&
            !$(this).hasClass("gallery-item") &&
            !$(this).hasClass("share") &&
    ...
    if ($(".dt-sc-tabs-vertical-frame").length > 0) {
        $(".dt-sc-tabs-vertical-frame").tabs(
    ...
    //**MAIN-MENU FUNCTIONS TYPE-2**//

    $(".total-overlay-trigger").on("click", function () {
        ...
        setTimeout(function () {
            var delay = 200;
            $(".total-overlay-sticky #navigation .menu.type2 > li > a").each(
                function () {
                    var $this = $(this);
                    setTimeout(function () {
                        $this.animate(
    ...
    $(".total-overlay-sticky-close").on("click", function () {
        $(".total-overlay-sticky").animate(
            {
                top: "-1400px",
                opacity: 0,
            ...
            800,
            function () {
                $(".total-overlay-sticky #navigation .menu.type2 > li > a").css(
                    {
                        opacity: 0,
                        left: "-50px",
                    }
    ...
    //**MAIN-MENU FUNCTIONS TYPE-2 ENDS**//
    ...
    $(".loadmore").on("click", function (e) {
        if (j == 3) {
            $(".loadmore")
                .html(
                    '<i class="fa fa-exclamation-triangle"></i> <span> Thats All!! </span>'
                )
                .css({ cursor: "default" });
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $(".loadmore").html(
                        '<i class="fa fa-magic"></i> <span> Loading... </span>'
                    );
                ...
                complete: function () {
                    if (j == 2) {
                        ...
                        $(".loadmore")
                            .html(
                                '<i class="fa fa-paint-brush"></i> <span> More Art </span>'
                            )
                            .css({ cursor: "pointer" });
    ...
    $(window).load(function () {
        ...
        jQuery(".dt-sc-donutchart").each(function () {
            ...
            var $bgColor =
                $this.data("bgcolor") !== undefined
                    ...
                    : "#5D18D6";
            var $fgColor =
                $this.data("fgcolor") !== undefined
                    ? $this.data("fgcolor")
                    : "#000000";
            var $size =
                $this.data("size") !== undefined ? $this.data("size") : "100";
        ...
        (function ($) {
            $(".dt-sc-progress").one("inview", function (event, visible) {
                ...
                if (visible == true) {
                    $this
                        .find(".dt-sc-bar")
                        .animate({ width: pvalue + "%" }, 600, function () {
        ...
        if ($map.length) {
            $map.gMapResp({
                address:
                    "Iamdesigning, 1/52,3/53, Lal Bahadhur Colony,Shringar Nagar Road, Near Gopal Naidu School, Peelamedu, Coimbatore, TN 641004",
                zoom: 16,
                markers: [
                    {
                        address:
        ...
        function chart() {
            ...
            $(".chart").each(function () {
                ...
                if (
                    ...
                    $this.attr("data-height") !== false
                ) {
                    height = $this.attr("data-height");
                }
                if (
                    $this.attr("data-line-width") !== undefined &&
                    $this.attr("data-line-width") !== false
                ) {
                    lineWidth = $this.attr("data-line-width");
                }
                if (
                    $this.attr("data-line-color") !== undefined &&
                    $this.attr("data-line-color") !== false
                ) {
                    lineColor = $this.attr("data-line-color");
                }
                if (
                    $this.attr("data-vertical-line-color") !== undefined &&
                    $this.attr("data-vertical-line-color") !== false
                ) {
                    verticalLineColor = $this.attr("data-vertical-line-color");
                }
                if (
                    $this.attr("data-spot-color-hovered") !== undefined &&
                    $this.attr("data-spot-color-hovered") !== false
                ) {
                    spotColorHovered = $this.attr("data-spot-color-hovered");
                }
                if (
                    $this.attr("data-spot-color") !== undefined &&
                    $this.attr("data-spot-color") !== false
                ) {
                    spotColor = $this.attr("data-spot-color");
                }
                if (
                    $this.attr("data-min-spot-color") !== undefined &&
                    $this.attr("data-min-spot-color") !== false
                ) {
                    minSpotColor = $this.attr("data-min-spot-color");
                }
                if (
                    $this.attr("data-max-spot-color") !== undefined &&
                    $this.attr("data-max-spot-color") !== false
                ) {
                    maxSpotColor = $this.attr("data-max-spot-color");
                }
                if (
                    $this.attr("data-bar-spacing") !== undefined &&
                    $this.attr("data-bar-spacing") !== false
                ) {
                    barSpacing = $this.attr("data-bar-spacing");
                }
                if (
                    $this.attr("data-bar-width") !== undefined &&
                    $this.attr("data-bar-width") !== false
                ) {
                    barWidth = $this.attr("data-bar-width");
                }
                if (
                    $this.attr("data-bar-color") !== undefined &&
                    $this.attr("data-bar-color") !== false
                ) {
                    barColor = $this.attr("data-bar-color");
                }
                if (
                    $this.attr("data-color-map") !== undefined &&
                    $this.attr("data-color-map") !== false
                ) {
                    colorMap = $this.attr("data-color-map").split(/, /);
                }
                if (
                    $this.attr("data-offset") !== undefined &&
                    $this.attr("data-offset") !== false
                ) {
                    offset = $this.attr("data-offset");
                }
                if (
                    $this.attr("data-slice-colors") !== undefined &&
                    $this.attr("data-slice-colors") !== false
                ) {
                    sliceColors = $this.attr("data-slice-colors").split(/, /);
                }
                if (
                    $this.attr("data-range-colors") !== undefined &&
                    $this.attr("data-range-colors") !== false
                ) {
                    rangeColors = $this.attr("data-range-colors").split(/, /);
                }
                if (
                    $this.attr("data-target-width") !== undefined &&
                    $this.attr("data-target-width") !== false
                ) {
                    targetWidth = $this.attr("data-target-width");
                }
                if (
                    $this.attr("data-pos-bar-color") !== undefined &&
                    $this.attr("data-pos-bar-color") !== false
                ) {
                    posBarColor = $this.attr("data-pos-bar-color");
                }
                if (
                    $this.attr("data-neg-bar-color") !== undefined &&
                    $this.attr("data-neg-bar-color") !== false
                ) {
                    negBarColor = $this.attr("data-neg-bar-color");
                }
                if (
                    $this.attr("data-performance-color") !== undefined &&
                    $this.attr("data-performance-color") !== false
                ) {
                    performanceColor = $this.attr("data-performance-color");
                }
                if (
                    $this.attr("data-fill-color") !== undefined &&
                    $this.attr("data-fill-color") !== false
                ) {
        ...
        if ($("#diagram").length) {
            var o = {
                ...
                diagram: function () {
                    ...
                    r.circle(160, 160, 40).attr({
                        stroke: "none",
                        fill: "#193340",
                    });

                    var title = r
                        .text(160, 160, defaultText)
                        .attr({
                            font: "12px Arial",
                            fill: "#fff",
                        })
